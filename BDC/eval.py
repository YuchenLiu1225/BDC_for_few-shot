...
if __name__ == '__main__':
    ...
    load_checkpoint="./outfiles2/best_model.nnet.pth"#"./outfiles_softmax/74.nnet.pth"
        ...
        if val_acc > best_acc:
            ...
            if test_acc > best_acc2:
                ...
                with open(filename,'a') as file_object:
                    ...
                    file_object.write(str(best_acc2))
                    file_object.write('\t')
